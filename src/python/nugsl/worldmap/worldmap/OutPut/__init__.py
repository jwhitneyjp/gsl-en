...
class outPut:
    ...
    def rsvg_output(self, basename ):
        ...
        return
        #
        # Since postprocessing maps for improved appearance is
        # a good idea and will be common in production, it is a BAD
        # idea to actually output JPG from this script.  This needs
        # be flagged prominently, but commenting this out is the
        # right thing to do.
        #
