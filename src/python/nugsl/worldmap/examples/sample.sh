...
python2.5 ../scripts/nugsl-worldmap -t flat \
...
python2.5 ../scripts/nugsl-worldmap -o demo_laopdr.svg \
               -c la \
...
python2.5 ../scripts/nugsl-worldmap -t rotated -o demo_index.svg -T clickablepage.html \
...
python2.5 ../scripts/nugsl-worldmap -o demo_japan.svg -c jp -C sample.countryconfig \
...
python2.5 ../scripts/nugsl-worldmap -o demo_indonesia.svg -c id -C sample.countryconfig \
               -P sample.pins -S sepia_country.sty -T clickablepage.html \
	       -x 1024 -y 450 -D -X -W 20

echo Generating "sepia" image of Cuba and clickable page
python2.5 ../scripts/nugsl-worldmap -o demo_cuba.svg -c cu -C sample.countryconfig \
               -P sample.pins -S sepia_country.sty -T clickablepage.html \
	       -x 1024 -y 450 -D -X -W 20

echo Generating "sepia" image of USA and clickable page
python2.5 ../scripts/nugsl-worldmap -o demo_usa.svg -c us -C sample.countryconfig \
               -P sample.pins -S sepia_country.sty -T clickablepage.html \
	       -x 1024 -y 450 -D -X -W 20

echo Generating "sepia" image of Mongolia and clickable page
python2.5 ../scripts/nugsl-worldmap -o demo_mn.svg -c mn -C sample.countryconfig \
               -P sample.pins -S sepia_country.sty -T clickablepage.html \
	       -x 1024 -y 450 -D -X -W 20

echo Generating "sepia" image of Britain and clickable page
python2.5 ../scripts/nugsl-worldmap -o demo_gb.svg -c gb -C sample.countryconfig \
               -P sample.pins -S sepia_country.sty -T clickablepage.html \
	       -x 1024 -y 450 -D -X -W 20
